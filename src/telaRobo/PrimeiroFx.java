...
public class PrimeiroFx extends Application{
	...
	public List<String> perfis = Arrays.asList("Perfil 1", "Assessor de Informsasjahodih slajshoiajso doaihsdoiahsoihaoish aoisjhoaijhsoiahoishaoihs aoshioaihsoiahsoihaoihsoiahsioh askbuhso");
	...
	public void telaPrincipal() {
		...
		containerInterno.add(botaoCadastrar, 0, 10, 10, 1);
	...
	public void telaTarefas() {
		...
		selecionar.setOnAction(e->{
			...
			int i = 0;
			String tarefasSelecionadasBuilder = "";
			for(CheckBox c : checkboxes) {
				if(c.isSelected()) {

					if(i<tamanhoLista) {
						tarefasSelecionadasBuilder.concat(c.getText()+"\",\n");
					} else {
						c.getText();
					}
