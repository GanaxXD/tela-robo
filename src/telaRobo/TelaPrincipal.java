...
public class TelaPrincipal extends Application {
	...
	public void telaPrincipal() {
		...
		// adicionando a um elemento as configuraçãos da classe .container definida no // css // Importando o css criado para minha classe: String caminhoCss =
		...
		perfilComboBox.setAccessibleHelp("Selecione o perfil do usuário usado no PJE para realizar a triagem de processos."); 
		...
		// Definindo tamanho mínimo dos componentespelo tamanho do tamanho do navegadorComboBox.setMinWidth(tamanhoIdeal);
		...
		// Centralizando e estilizando a página tela.setAlignment(Pos.CENTER);

		// Definindo espaçamento entre os elementos tela.setSpacing(30.0);
	...
	public void telaTarefas() {
		...
		// número de linhas e colunas da grid: dividir as tarefas em grupos de 2 +
